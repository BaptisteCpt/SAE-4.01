...
/**
 * Composant pour modifier les informations d'un administrateur
 * Charge les données de l'administrateur et permet de modifier le login et le mot de passe
 * @returns {JSX.Element} Le formulaire de modification d'administrateur
 */
export default function ModifAdmin() {
    ...
    useEffect(() => {
        ...
        /**
         * Charge les données de l'administrateur depuis l'API
         */
    ...
    /**
     * Valide et soumet les modifications de l'administrateur
