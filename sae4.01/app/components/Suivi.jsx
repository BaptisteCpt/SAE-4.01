    ...
    <div className="liste_etapes">
      ...
      <label>
        ...
        <SearchableSelect
          ...
          placeholder="-- Numéro du chantier --"
        />
      </label>
      {numero_chantier &&
        Etapes.map((etape) => (
            ...
            <div className="etape-dates">
              <div>
                ...
                <input
                  type="date"
                  defaultValue={
                    etape.dateTheo ? etape.dateTheo.slice(0, 10) : ""
                  }
              ...
              <div>
                ...
                <input
                  type="date"
                  defaultValue={
                    etape.dateDebut ? etape.dateDebut.slice(0, 10) : ""
                  }
      ...
      {numero_chantier && <button onClick={Valider}>Valider</button>}
      {error && <p>{error}</p>}
    </div>
  );
}
