            ...
            <>
              <label className="full-width">
                ...
                <SearchableSelect
                  ...
                  getOptionLabel={(etape) => `${etape.id} - ${etape.nom}`}
                ...
                {ArtisanCourrant !== undefined ? (
                  <label>
                    ...
                    <SearchableSelect
                      ...
                      onChange={(value) => setArtisanCourrant(Number(value))}
                      getOptionValue={(artisan) => artisan.noartisan}
                      getOptionLabel={(artisan) =>
                        `${artisan.nomartisan.trim()} - ${artisan.prenomartisan.trim()}`
                      }
                  ...
                  <div className="no-data">
                    Aucun artisan qualifié trouvé pour cette étape.
                  </div>
                )}
              </div>
            </>
