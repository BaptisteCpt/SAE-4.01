    ...
    return (
        ...
        <div className="boutons_accueil">
            <div className="bloc-accueil">
                <img src="/img/maison-icone.png" onClick={pageCom} />
            ...
            <div className="bloc-accueil">
                <img src="/img/dossier.png" onClick={pageArti} />
            ...
            <div className="bloc-accueil">
                    <img src="/img/client.png" onClick={pageMOE} />
            ...
            <div className="bloc-accueil">
                    <img src="/img/client.png" onClick={pageAdmin} />
